...
public class PostControllerTest {
    ...
    @Test
    @WithMockUser
    void 포스트수정시_수령하려는_글이_없는_경우() throws Exception {
        String title = "title";
        String body = "body";
    ...
    @Test
    @WithMockUser
    void 포스트삭제시_삭제하려는_글이_없는_경우() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void My피드목록요청시_로그인하지_않은_경우() throws Exception {
        // mocking
        when(postService.myList(any(), any())).thenReturn(Page.empty());
    ...
    @Test
    @WithAnonymousUser
    void 좋아요클릭시_로그인하지_않은_경우() throws Exception {
        mockMvc.perform(post("/api/v1/posts/1/likes")
                        .contentType(MediaType.APPLICATION_JSON)
                ).andDo(print())
                .andExpect(status().isUnauthorized());
    ...
    @Test
    @WithMockUser
    void 좋아요클릭시_피드가없는_경우() throws Exception {
    ...
    @Test
    @WithMockUser
    void 댓글작성시_피드가없는_경우() throws Exception {
